...
一直想做一款养老管理系统，看了很多优秀的开源项目但是发现没有合适的。于是利用空闲休息时间开始自己写了一套管理系统。
学习过程中遇到问题可以咨询微信：lengqin1024 或者发Email: kefu308@gmail.com

## 在线体验


- 代码下载：https://github.com/geeeeeeeek/python_yanglao
- 演示地址：http://yanglao.gitapp.cn/
...
- 老人管理：管理系统可以录入、修改和查询老人的基本信息，如老人名称、年龄、备注等。
- 房间管理：房间信息的增删改查。
- 护工管理：护工信息的增删改查。
- 亲属管理：亲属信息的增删改查。
- 病史管理：病史信息的增删改查。
...
在老人管理系统中，需要存储和管理老人信息、评论信息、分类信息、标签信息、用户信息、通知信息、日志信息。
...
Table family {
    ...
    sex varchar // 性别
    age varchar // 年龄
    oldperson varchar // 对应老人
    relation varchar // 与老人关系
    remark varchar // 备注
    create_time datetime
 }
...
无论是老人管理、用户管理、房间管理、亲属管理、日志管理、护工管理等功能都是基于springboot+vue框架开发的，开发流程是：
...
下面用老人管理功能来演绎这个流程，其它的管理功能都是这个流程。
        ...
        <div style="padding-right: 16px; max-height: 480px; overflow-x: hidden; overflow-y: auto">
          <a-form ref="myform" :label-col="{ style: { width: '80px' } }" :model="modal.form" :rules="modal.rules">
            <a-row :gutter="24">
              ...
              <a-col span="12">
                <a-form-item label="房间名称" name="classification">
                  <a-select
                    placeholder="请选择"
                    allowClear
                    :options="modal.cData"
...
这就是老人管理功能的实现流程，其它的功能管理实现一模一样的。按照这个流程编写即可。
