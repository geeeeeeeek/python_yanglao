            ...
            <a-row :gutter="24">
              ...
              <a-col span="12">
                <a-form-item label="技能" name="skill">
                  <a-input placeholder="请输入" v-model:value="modal.form.skill" />
                </a-form-item>
              </a-col>
              <a-col span="12">
...
<script setup lang="ts">
  ...
  import { createApi, listApi, updateApi, deleteApi } from '/@/api/worker';
  ...
  const handleOk = () => {
    myform.value
      ...
      .then(() => {
        ...
        formData.append('skill', modal.form.skill || '');
