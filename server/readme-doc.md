...
> 基于django+mysql开发的养老管理系统，本文档包括功能说明、数据库设计、开发过程。学习过程遇到问题可以咨询作者：lengqin1024（微信）

## 功能说明

- 老人管理（包括老人的新增、查询、删除、编辑功能）
- 房间管理（包括房间的新增、查询、删除、编辑功能）
- 护工管理（包括护工的新增、查询、删除、编辑功能）
- 病史管理（包括病史的新增、查询、删除、编辑功能）
- 亲属管理（包括亲属的新增、查询、删除、编辑功能）
- 活动管理（包括各种活动的新增、查询、删除、编辑功能）
...
无论是用户管理、房间管理、老人管理等功能都是基于django的restframework框架开发的，开发流程是：
- 第一步：编写model模型
- 第二步：编写序列化器
- 第三步：编写view视图
- 第四步：配置url接口地址
